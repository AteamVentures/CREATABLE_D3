...
#endif
//CREATABLE D2s new Header
#if (THERMISTORHEATER_0 == 1407) || (THERMISTORHEATER_1 == 1407)  || (THERMISTORHEATER_2 == 1407) || (THERMISTORBED == 1407) //100k bed thermistor

const short temptable_1407[][2] PROGMEM = {
   {1*OVERSAMPLENR ,  864},
   {11*OVERSAMPLENR ,  404},
   {21*OVERSAMPLENR ,  337},
   {31*OVERSAMPLENR ,  302},
   ...
   {81*OVERSAMPLENR ,  220},
   {91*OVERSAMPLENR ,  210},
   {101*OVERSAMPLENR ,  200},
   {111*OVERSAMPLENR ,  195},
   {121*OVERSAMPLENR ,  190},
   {131*OVERSAMPLENR ,  186},
   {141*OVERSAMPLENR ,  183},
   {151*OVERSAMPLENR ,  181},
   {161*OVERSAMPLENR ,  179},
   {171*OVERSAMPLENR ,  177},
   {181*OVERSAMPLENR ,  175},
   {191*OVERSAMPLENR ,  173},
   {201*OVERSAMPLENR ,  171},
   {211*OVERSAMPLENR ,  168},
   {221*OVERSAMPLENR ,  166},
   {231*OVERSAMPLENR ,  163},
...
#if (THERMISTORHEATER_0 == 1408) || (THERMISTORHEATER_1 == 1408) || (THERMISTORHEATER_2 == 1408) || (THERMISTORBED == 1408)
// 100k 0603 SMD Vishay NTCS0603E3104FXT (4.7k pullup)
const short temptable_1408[][2] PROGMEM = {
   {1*OVERSAMPLENR, 816},
   {11*OVERSAMPLENR, 391},
   {21*OVERSAMPLENR, 327},
   {31*OVERSAMPLENR, 294},
