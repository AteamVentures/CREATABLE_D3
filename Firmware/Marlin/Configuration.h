...
#define STRING_CONFIG_H_AUTHOR "Version 1.1.6" // Who made the changes.
...
#define FILAMENT_LOAD_TEMP          220
#define FILAMENT_UNLOAD_LEN         700  
#define FILAMENT_LOAD_LEN           600  // 
#define FILAMENT_LOAD_LEN2          100  // 
...
#define DELTA_SMOOTH_ROD_OFFSET 169.445 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 29.445 // mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 15.1 // mm
...
#define HEATER_1_MINTEMP -80
#define HEATER_2_MINTEMP -80
...
// TODO
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0.00// Increase this if the first layer is too thin. This decreases gap about film thickness
#else
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0.00// Increase this if the first layer is too thin. This decreases gap about film thickness
#endif
...
#define DEFAULT_MAX_ACCELERATION      {5000,5000,5000,9000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
